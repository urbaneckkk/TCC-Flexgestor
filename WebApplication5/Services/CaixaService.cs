...
namespace WebApplication5.Services
{
    public class CaixaService
    {
        ...
        public CaixaModel? BuscarAberto(int idEmpresa) => _repo.BuscarAberto(idEmpresa);
        ...
        public IEnumerable<CaixaModel> ListarHistorico(int idEmpresa) => _repo.ListarHistorico(idEmpresa);
        ...
        public int Lancar(int idEmpresa, int idUsuario, LancarCaixaDto dto)
        {
            ...
            var caixa = _repo.BuscarAberto(idEmpresa) ?? throw new InvalidOperationException("Nenhum caixa aberto.");
        ...
        public IEnumerable<FormaPagamentoModel> ListarFormasPagamento(int idEmpresa) => _repo.ListarFormasPagamento(idEmpresa);
        public IEnumerable<CategoriaFinanceiraModel> ListarCategorias(int idEmpresa) => _repo.ListarCategorias(idEmpresa);
        ...
        public int VendaRapida(int idEmpresa, int idUsuario, VendaRapidaDto dto, int idCategoriaVenda)
        {
            ...
            if (dto.Fiado)
            {
                if (dto.ClienteId == null) throw new InvalidOperationException("Cliente obrigatório para venda no fiado.");
        ...
        public IEnumerable<ContaReceberModel> ListarContasReceber(int idEmpresa) => _repo.ListarContasReceber(idEmpresa);
        public int CriarContaReceber(int idEmpresa, CriarContaReceberDto dto) => _repo.CriarContaReceber(idEmpresa, dto, null);
